...
<div class="content-card add-store-page">
    ...
    <!-- FORM -->
    <form action="/admin/editblogpost?id=<?php echo $post['id']; ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-right">
                <input type="text" name="Title" class="form-control-custom" value="<?php echo htmlspecialchars($post['title']); ?>" required />
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-right">
                <input type="text" name="Slug" id="slug" class="form-control-custom" value="<?php echo htmlspecialchars($post['slug']); ?>" required />
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-right">
                <?php if (!empty($post['thumbnail'])): ?>
                    <div class="mb-2">
                        <img src="<?php echo htmlspecialchars($post['thumbnail']); ?>" alt="Current Thumbnail" style="max-width: 150px; border-radius: 4px; border: 1px solid #ddd;" />
        ...
        <div class="form-row">
            <label>Tags</label>
            <div class="form-right">
                <input type="text" name="Tags" class="form-control-custom" value="<?php echo htmlspecialchars($tagText ?? ''); ?>" placeholder="Ví dụ: AI, Web Development, Tutorial (cách nhau bằng dấu phẩy)" />
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-right">
                <textarea name="Summary" class="editor-box" rows="3" placeholder="Tóm tắt ngắn gọn bài viết để hiển thị ở danh sách bài..."><?php echo htmlspecialchars($post['summary'] ?? ''); ?></textarea>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-right">
                <textarea name="Content" id="Content" class="editor-box" rows="15" placeholder="Nội dung bài viết..."><?php echo htmlspecialchars($post['content'] ?? ''); ?></textarea>
            </div>
        </div>
        ...
        <div class="my-4 border-top pt-3">
            ...
            <div class="form-row">
                ...
                <div class="form-right">
                    <input type="text" name="SeoTitle" class="form-control-custom" value="<?php echo htmlspecialchars($post['seo_title'] ?? ''); ?>" placeholder="Mặc định sử dụng tiêu đề bài viết" />
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-right">
                    <textarea name="SeoDescription" class="form-control-custom" rows="3" placeholder="Mô tả SEO tối ưu hóa tìm kiếm Google"><?php echo htmlspecialchars($post['seo_description'] ?? ''); ?></textarea>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-right">
                    <input type="url" name="CanonicalUrl" class="form-control-custom" value="<?php echo htmlspecialchars($post['canonical_url'] ?? ''); ?>" placeholder="https://example.com/canonical-url" />
                </div>
            </div>
        </div>
