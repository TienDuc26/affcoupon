...
<head>
    ...
    <title>Đăng nhập - Peak Vouch</title>
    <!-- Google Font: Inter -->
...
<body>
    ...
    <div class="auth-card">
        <div class="auth-header">
            ...
            <p class="text-white-50 small mb-0 mt-2">Đăng nhập tài khoản quản trị & tiếp thị liên kết</p>
        </div>
        ...
        <div class="auth-body">
            ...
            <form method="POST" action="/account/login">
                ...
                <button type="submit" class="btn btn-success-premium w-100 mb-3">Đăng nhập</button>
            </form>

            <div class="text-center small text-muted mt-4">
                Chưa có tài khoản? <a href="/account/register" class="auth-footer-link">Đăng ký ngay</a>
            </div>
        </div>
    </div>
