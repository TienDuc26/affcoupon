<section class="py-5 bg-light min-vh-100">
    <div class="container">
        <div class="mb-5">
            <span class="badge bg-danger-subtle text-danger mb-2 fw-bold">Tài khoản</span>
            <h1 class="fw-bold text-dark"><i class="fa-solid fa-heart text-danger me-2"></i> Coupon yêu thích của bạn</h1>
            <p class="text-muted">Danh sách các thương hiệu và mã giảm giá bạn đã yêu thích.</p>
        </div>
        ...
        <?php if (!empty($Coupons)): ?>
            ...
            <?php if ($TotalPages > 1): ?>
                <div class="pagination-premium mt-5">
                    <?php 
                        $prevUrl = $CurrentPage > 1 ? "/account/favorites?page=" . ($CurrentPage - 1) : "#";
                        $nextUrl = $CurrentPage < $TotalPages ? "/account/favorites?page=" . ($CurrentPage + 1) : "#";
                    ?>
                    ...
                    <?php for ($i = 1; $i <= $TotalPages; $i++): ?>
                        <a href="/account/favorites?page=<?php echo $i; ?>" class="<?php echo $i === $CurrentPage ? 'active' : ''; ?>">
                            <?php echo $i; ?>
                        </a>
                    <?php endfor; ?>
        ...
        <?php else: ?>
            <div class="empty-state bg-white">
                ...
                <p class="text-muted mb-4">Khám phá hàng trăm ưu đãi hấp dẫn đang chờ đón bạn.</p>
